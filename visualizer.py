...
class Visualizer:
    ...
    def __init__(self, rows=15, cols=15):
        ...
        self.result_time   = 0
        self.result_count  = 0
        self.message       = "L-Click:Wall|R-Click:Start|M-Click:Goal"
    ...
    def _draw_sidebar(self):
        ...
        # Message - Using smaller font to fit mapping instructions
        self.screen.blit(self.font_xs.render(self.message, True, YELLOW), (sx + 5, self.win_h - 30))
    ...
    def _handle_grid_click(self, event):
        # Click grid cells to place walls or move start/goal
    ...
    def _animate_agent(self):
        ...
        if self.dynamic_mode:
            ...
            new_wall  = self.grid.spawn_dynamic_obstacle(remaining, spawn_probability=0.05)
